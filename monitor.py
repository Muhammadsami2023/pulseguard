...
# ─────────────────────────────────────────
# STORAGE FILE
# We save all active loans in a JSON file
# Simple, free, no database needed for MVP
# ─────────────────────────────────────────
...
# Reads from our local JSON file
# ─────────────────────────────────────────
def load_loans():
...
# ─────────────────────────────────────────
# SAVE ALL ACTIVE LOANS
# Writes back to our local JSON file
# ─────────────────────────────────────────
...
# Called when bank approves a loan
# ─────────────────────────────────────────
...
# Called when we re-check a company
# ─────────────────────────────────────────
    ...
    for loan in loans:
        if loan["ticker"] == ticker.upper() and loan["status"] == "ACTIVE":
            ...
            loan["score_history"].append({
                ...
                "score": new_score,
                "note": f"Routine monitoring check"
            })
...
# ─────────────────────────────────────────
# GET LOAN STATUS
# Returns current status of a specific loan
# ─────────────────────────────────────────
...
# Returns overview of all monitored loans
# ─────────────────────────────────────────
